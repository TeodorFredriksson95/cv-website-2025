      ...
      <main className="flex flex-col  row-start-2 w-full">
        ...
        <Section>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 ">
            <div className="">
              <div className="flex border-2 border-black/20 flex-col flex-1 bg-secondary-green/50 rounded-md shadow-2xl p-2   h-full">
                <div className="">
                  <div className=" bg-secondary-cream rounded-md">
                    <h2 className="text-3xl bg-secondary-green rounded-t p-4 font-extrabold text-secondary-cream mb-2">
                      The Florist
                    </h2>
                    <p className="text-md font-mono p-4 font-semibold mb-4">
                      Designed to support florists in planning and crafting
                      flower arrangements based on occasion. Users could explore
                      and study flora in a searchable library sourced via the{" "}
                      <Link
            ...
            <div className="">
              <div className="flex flex-col flex-1 border-2 border-black/20 bg-secondary-purple/50 rounded-md shadow-2xl p-2 h-full">
                <div className=" rounded-md">
                  <div className="bg-secondary-cream rounded-t">
                    <h2 className="text-3xl bg-secondary-purple p-4 rounded-t font-extrabold text-secondary-cream mb-2">
                      Mapping Industries
                    </h2>
                    <p className="text-md font-mono p-4 font-semibold ">
                      Built during my internship at Redmind AB, this project
                      focused on backend systems and UI features to manage local
                      work orders at golf clubs world wide using GIS functions.
                    </p>
                  </div>
                  <div className="bg-secondary-brown rounded shadow-lg/20 ">
                    <p className="text-xl p-2 font-bold bg-accent-orange   ">
                      Focus areas:
                    </p>
                    <div className="p-4 bg-gray-50/90 inset-shadow-sm inset-shadow-black ">
